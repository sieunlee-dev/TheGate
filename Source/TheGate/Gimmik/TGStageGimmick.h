...
#include "TGStageGimmick.generated.h"
...
UCLASS()
class THEGATE_API ATGStageGimmick : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<class ATGCharacterNonPlayer> OpponentClass;
...
protected:
	...
	TSubclassOf<class ATGItemBox> RewardBoxClass;

	UPROPERTY(VisibleAnywhere, Category = Reward, Meta = (AllowPrivateAccess = "true"))
	TArray<TWeakObjectPtr<class ATGItemBox>> RewardBoxes;
